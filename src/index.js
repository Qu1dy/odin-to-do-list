...
const eventHandler = (() => {
  ...
  const _onProjectFormSubmit = () => {
    const [data, projectId] = _onFormSubmit(
      projectForm,
      renderer.hideProjectForm
    );
  ...
  const _handleCategoryEvents = () => {
    ...
    _handleCategoryEvent(
      showOnlyDueThisWeek,
      ProjectManager.getTasksDueThisWeek
    );
  };
  ...
  const _handleFormEvents = () => {
    _handleForm(
      createTaskButton,
      renderer.showTaskForm,
      taskForm,
      _onTaskFormSubmit
    );
    _handleForm(
      createProjectButton,
      renderer.showProjectForm,
      projectForm,
      _onProjectFormSubmit
    );
  };
